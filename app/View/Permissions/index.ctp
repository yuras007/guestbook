<div class="permissions index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('Переглянути'), array('action' => 'view', $permission['Permission']['id'])); ?>
			<?php echo $this->Html->link(__('Редагувати'), array('action' => 'edit', $permission['Permission']['id'])); ?>
			<?php echo $this->Form->postLink(__('Видалити'), array('action' => 'delete', $permission['Permission']['id']), null, __('Are you sure you want to delete # %s?', $permission['Permission']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
